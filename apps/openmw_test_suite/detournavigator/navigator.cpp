...
namespace
{
    ...
    TEST_F(DetourNavigatorNavigatorTest, path_should_be_over_water_when_use_swim_flag)
    {
        ...
        EXPECT_EQ(mPath, std::deque<osg::Vec3f>({
            osg::Vec3f(-215, 215, 5.705125331878662109375),
            osg::Vec3f(-187.8035888671875, 187.8035888671875, 1.17239058017730712890625),
            osg::Vec3f(-160.607177734375, 160.607177734375, -3.3603441715240478515625),
            osg::Vec3f(-133.4107666015625, 133.4107666015625, -7.8930797576904296875),
            osg::Vec3f(-106.21435546875, 106.21435546875, -9.6153850555419921875),
            osg::Vec3f(-79.01793670654296875, 79.01793670654296875, -9.6153850555419921875),
            osg::Vec3f(-51.821521759033203125, 51.821521759033203125, -9.6153850555419921875),
            osg::Vec3f(-24.6251068115234375, 24.6251068115234375, -9.6153850555419921875),
            osg::Vec3f(2.57130527496337890625, -2.57130527496337890625, -9.6153850555419921875),
            osg::Vec3f(29.7677173614501953125, -29.7677173614501953125, -9.6153850555419921875),
            osg::Vec3f(56.96413421630859375, -56.96413421630859375, -9.6153850555419921875),
            osg::Vec3f(84.16054534912109375, -84.16054534912109375, -9.6153850555419921875),
            osg::Vec3f(111.35695648193359375, -111.35695648193359375, -9.6153850555419921875),
            osg::Vec3f(138.553375244140625, -138.553375244140625, -7.0359783172607421875),
            osg::Vec3f(165.749786376953125, -165.749786376953125, -2.5032465457916259765625),
            osg::Vec3f(192.9461822509765625, -192.9461822509765625, 2.029489994049072265625),
            osg::Vec3f(215, -215, 5.705122470855712890625),
        }));
    }
    ...
    TEST_F(DetourNavigatorNavigatorTest, path_should_be_around_water_when_use_only_walk_flag)
    {
        ...
        EXPECT_EQ(mPath, std::deque<osg::Vec3f>({
            osg::Vec3f(-215, 215, 5.705125331878662109375),
            osg::Vec3f(-204.90869140625, 177.8859100341796875, 4.023241519927978515625),
            osg::Vec3f(-194.8173828125, 140.771820068359375, 2.341356754302978515625),
            osg::Vec3f(-184.7260589599609375, 103.65773773193359375, 0.659469783306121826171875),
            osg::Vec3f(-174.634735107421875, 66.54364776611328125, -1.02241384983062744140625),
            osg::Vec3f(-164.5434417724609375, 29.429561614990234375, -2.7042992115020751953125),
            osg::Vec3f(-154.4521331787109375, -7.684524059295654296875, -4.3861865997314453125),
            osg::Vec3f(-144.3608245849609375, -44.798610687255859375, -6.068071842193603515625),
            osg::Vec3f(-134.269500732421875, -81.91269683837890625, -7.749958038330078125),
            osg::Vec3f(-124.17818450927734375, -119.0267791748046875, -9.43184566497802734375),
            osg::Vec3f(-114.08687591552734375, -156.140869140625, -4.104731082916259765625),
            osg::Vec3f(-76.2261505126953125, -162.9124908447265625, -2.9761240482330322265625),
            osg::Vec3f(-38.365413665771484375, -169.684112548828125, -1.84752380847930908203125),
            osg::Vec3f(-0.504681646823883056640625, -176.4557342529296875, -0.718920230865478515625),
            osg::Vec3f(37.356048583984375, -183.2273406982421875, 0.4096839129924774169921875),
            osg::Vec3f(75.2167816162109375, -189.99896240234375, 1.53828656673431396484375),
            osg::Vec3f(113.0775146484375, -196.77056884765625, 2.6668872833251953125),
            osg::Vec3f(150.9382476806640625, -203.5421905517578125, 3.795490264892578125),
            osg::Vec3f(188.7989654541015625, -210.31378173828125, 4.924090862274169921875),
            osg::Vec3f(215, -215, 5.705122470855712890625),
        }));
    }
